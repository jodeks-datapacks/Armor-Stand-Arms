...
scoreboard objectives remove armorstandarms.image

scoreboard objectives remove armorstandarms.placed 

scoreboard objectives remove armorstandarms.raycast_start
scoreboard objectives remove armorstandarms.raycast_hit
scoreboard objectives remove armorstandarms.raycast_distance
scoreboard objectives remove armorstandarms.raycast_check

scoreboard objectives remove armorstandarms.config
