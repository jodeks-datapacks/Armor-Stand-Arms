...
**For version 1.21 and up you can right click armor stands to show or remove the arms from one armor stand**

If you want to **remove all arms** from **all armor stands** run

```
/function armorstandarms:app/arms/remove_all
```
and to **enable** them again run
...
---
(Only works below 1.21) If you want to **remove the arms** from **only one armor stand** run:
